...
public class TaskResource {
    ...
    protected static TaskResource _instance = null; // La instancia inicialmente no existe, se crea al ejecutar .getInstance().
    ...
    public static TaskResource getInstance() {
        ...
        return (_instance == null) ? new TaskResource() : _instance;
    }
    ...
    private void orderResult(List<Task> result, String order) {
        if (order.equals("title")) 
        	Collections.sort(result, Comparator.comparing(Task::getTitle));
    }
